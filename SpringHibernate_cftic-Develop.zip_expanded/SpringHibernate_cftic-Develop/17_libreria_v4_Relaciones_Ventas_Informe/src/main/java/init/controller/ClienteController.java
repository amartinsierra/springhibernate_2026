...
public class ClienteController {
	...
	public String login(Model model, HttpSession session,
		...
		ClienteDto cliente = clienteService.buscar(usuario, pwd);
		if (cliente == null) {
			model.addAttribute("mensaje", "El usuario o contraseña no son correctos.");
			return "mensaje";
		}
	...
	public String añadirCarrito(Model model, HttpSession session,
	    ...
	    LibroDto libro = libroService.findById(isbn);
