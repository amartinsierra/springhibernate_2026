...
public class Mapeador {
	...
	public Libro libroDtoToEntity(LibroDto libro) {	
		return new Libro(libro.getIsbn(),libro.getTitulo(),libro.getAutor(),libro.getPaginas(),libro.getPrecio(),temaDtoToEntity(libro.getTemaDto()));
	}
	...
	public VentaDto ventaEntityToDto(Venta venta) {
		return new VentaDto(clienteEntityToDto(venta.getCliente()),
