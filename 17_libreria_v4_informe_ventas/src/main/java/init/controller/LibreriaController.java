...
public class LibreriaController {
	...
	@GetMapping("informe")
	public String informe(Model model, @RequestParam String fecha1, @RequestParam String fecha2) {		
		...
		model.addAttribute("ventas", ventasService.ventasPorFechas(ld1, ld2));
		return "ventas";
	}
